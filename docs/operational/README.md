...
| [`operator-setup-runbook.md`](operator-setup-runbook.md) | Fresh Mac setup walkthrough: Yubikey unlock, Infisical auth, Claude Code auth, multi-account bootstrap, cross-device sync wiring |
