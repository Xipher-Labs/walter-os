...
- AI-stack resilience: the release documents that Claude and Codex are
  supported agent surfaces, not mandatory dependencies.
- Security tracking: GitHub code-scanning alerts are grouped into follow-up
  issues #390 through #396 so remediation can proceed without burying the
  release.
...
- #390-#396: GitHub code-scanning remediation follow-ups created for the open
  CodeQL/Scorecard alerts.
